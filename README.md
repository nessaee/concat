...
**concat** (v0.1.5) is a high-performance CLI suite designed to prepare codebases for Large Language Models (LLMs). It consists of two powerful tools that follow the Unix Philosophy:
